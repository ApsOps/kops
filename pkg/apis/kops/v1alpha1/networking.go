...
type NetworkingSpec struct {
	...
	VXLAN    *VXLANNetworkingSpec    `json:"vxlan,omitempty"`
}
...
// VXLAN declares that we want VXLAN networking, rather than specifying a particular implementation.
type VXLANNetworkingSpec struct {
}
